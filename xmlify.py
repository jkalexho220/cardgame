...
ln = 1
if FILE_1 == 'all':
	files = ['shared.c', 'board.c', 'prologue.c', 'clicking.c', 'cards.c', 'gameplayHelpers.c', 'deck.c', 'dataLoad.c', 'collection.c', 'OnDeath.c', 'spellcasting.c', 'OnAttack.c', 'OnPlay.c', 'gameplay.c', 'bot.c', 'match.c', 'story.c']
	named = True
