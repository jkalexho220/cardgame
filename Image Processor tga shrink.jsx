...
function SaveAsJPEG( inFileName, inQuality, inEmbedICC ) {
	...
	targaOptions.alphaChannels = false;
	targaOptions.rleCompression = true;
	app.activeDocument.resizeImage(UnitValue(820, "px"), UnitValue(630, "px"), 72, ResampleMethod.BICUBIC);
	//app.activeDocument.resizeCanvas(UnitValue(820, "px"),UnitValue(630, "px"))
	app.activeDocument.saveAs( File( inFileName ), targaOptions );
}
